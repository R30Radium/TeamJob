...
public class PetPhotoService {
    Logger logger = LoggerFactory.getLogger(PetPhotoService.class);
    ...
    public PetPhotoService(PetPhotoRepository petPhotoRepository, RecordRepository recordRepository) {
